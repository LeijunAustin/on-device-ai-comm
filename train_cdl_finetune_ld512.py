...
AWGN_WEIGHTS = 'checkpoints/image-jscc/recon_ld512_2026-03-24_21-40-03/best_psnr23.32.weights.h5'
LATENT_DIM = 512

def main():
    ts = datetime.now().strftime('%Y-%m-%d_%H-%M-%S')
    out = f'checkpoints/image-jscc/recon_cdl_finetune_ld512_{ts}'
    ...
    print(f"AWGN 权重加载完成: {AWGN_WEIGHTS}")
    ...
    print(f"\nDone. Best CDL ld=512 PSNR: {best:.2f} dB → {out}")
